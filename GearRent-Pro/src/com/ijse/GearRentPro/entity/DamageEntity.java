...
public class DamageEntity {
    ...
    public DamageEntity(String damageId, String rentalId, String description, double damageCharge) {
    ...
    public String toString() {
        return "DamageEntity{" + "damageId=" + damageId + ", rentalId=" + rentalId + ", description=" + description + ", damageCharge=" + damageCharge + '}';
    }
