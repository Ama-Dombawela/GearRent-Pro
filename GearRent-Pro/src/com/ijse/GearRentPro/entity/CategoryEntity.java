...
public class CategoryEntity {
    ...
    public String toString() {
        return "CategoryEntity{" + "categoryId=" + categoryId + ", name=" + name + ", description=" + description + ", priceFactor=" + priceFactor + ", weekendMutiplier=" + weekendMutiplier + ", lateFeePerDay=" + lateFeePerDay + ", isActive=" + isActive + '}';
    }
